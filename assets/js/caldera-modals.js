(function($){
	...
	$.calderaModal = function(opts,trigger){
		...
		if( defaults.footer ){
			...
			if( typeof window[defaults.footer] === 'function' ){
				calderaModals[ modalId ].footer.append( window[defaults.footer]( defaults, calderaModals[ modalId ] ) );
		...
		if( defaults.content ){
			...
			if( typeof window[defaults.content] === 'function' ){
				calderaModals[ modalId ].content.append( window[defaults.content]( defaults, calderaModals[ modalId ] ) );
